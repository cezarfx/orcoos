...
const CastError = OrcoosError.CastError;
const ValidatorError = OrcoosError.ValidatorError;
...
SchemaType.prototype.default = function(val) {
  if (arguments.length === 1) {
    ...
    if (val != null && val.instanceOfSchema) {
      throw new OrcoosError('Cannot set default value of path `' + this.path +
 ...
 * validation failed.
 *
 * The error message argument is optional. If not passed, the [default generic error message template](#error_messages_OrcoosError-messages) will be used.
 *
 * #### Example:
 *
 ...
 * [here](#error_messages_OrcoosError-messages).
 *
...
SchemaType.prototype.validate = function(obj, message, type) {
  if (typeof obj === 'function' || obj && utils.getFunctionName(obj.constructor) === 'RegExp') {
    ...
    if (typeof message === 'function') {
      ...
      if (message == null) {
        message = OrcoosError.messages.general.default;
      }
      if (!type) {
        type = 'user defined';
      }
 ...
 * @return {SchemaType} this
 * @see Customized Error Messages #error_messages_OrcoosError-messages
...
SchemaType.prototype.required = function(required, message) {
  ...
  const msg = message || OrcoosError.messages.general.required;

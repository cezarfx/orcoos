...
/**
 * OrcoosError constructor. OrcoosError is the base class for all
 ...
 * possible values are:
 *
 * - `OrcoosError`: general Mongoose error
...
module.exports = exports = OrcoosError;

/**
 * The default built-in validator error messages.
 *
 * @see Error.messages #error_messages_OrcoosError-messages
 * @api public
 * @memberOf Error
 * @static
 */

OrcoosError.messages = require('./messages');

// backward compat
OrcoosError.Messages = OrcoosError.messages;
...
OrcoosError.DocumentNotFoundError = require('./notFound');
...
OrcoosError.CastError = require('./cast');
...
OrcoosError.ValidationError = require('./validation');
...
OrcoosError.ValidatorError = require('./validator');
...
OrcoosError.VersionError = require('./version');
...
OrcoosError.ParallelSaveError = require('./parallelSave');
...
OrcoosError.OverwriteModelError = require('./overwriteModel');
...
OrcoosError.MissingSchemaError = require('./missingSchema');
...
OrcoosError.MongooseServerSelectionError = require('./serverSelection');
...
OrcoosError.DivergentArrayError = require('./divergentArray');
...
OrcoosError.StrictModeError = require('./strict');
...
OrcoosError.StrictPopulateError = require('./strictPopulate');

...
SchemaNumber.prototype.min = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || OrcoosError.messages.Number.min;
...
SchemaNumber.prototype.max = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || OrcoosError.messages.Number.max;
...
SchemaNumber.prototype.enum = function(values, message) {
  ...
  if (!Array.isArray(values)) {
    ...
    message = message || OrcoosError.messages.Number.enum;
  }

  message = message == null ? OrcoosError.messages.Number.enum : message;

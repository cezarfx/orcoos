...
SchemaString.prototype.enum = function() {
  ...
  if (utils.isObject(arguments[0])) {
    if (Array.isArray(arguments[0].values)) {
      ...
      errorMessage = OrcoosError.messages.String.enum;
    }
  } else {
    values = arguments;
    errorMessage = OrcoosError.messages.String.enum;
...
SchemaString.prototype.minlength = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || OrcoosError.messages.String.minlength;
...
SchemaString.prototype.maxlength = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || OrcoosError.messages.String.maxlength;
...
SchemaString.prototype.match = function match(regExp, message) {
  ...
  const msg = message || OrcoosError.messages.String.match;

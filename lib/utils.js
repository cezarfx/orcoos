...
exports.warn = function warn(message) {
  return process.emitWarning(message, { code: 'ONDBMONGOOSE' });
};

exports.warnWithType = function warnWithType(type, message) {
  return process.emitWarning(message, { code: 'ONDBMONGOOSE', type: type});
};

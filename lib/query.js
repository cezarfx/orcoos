...
Query.prototype._find = async function _find() {
  ...
  const cursor = await this._collection.collection.find(filter, options, this.schema);
  if (options.explain) {
...
Query.prototype.find = function(conditions) {
  if (typeof conditions === 'function' ||
    ...
    throw new OrcoosError('Query.prototype.find() no longer accepts a callback');
  }
...
Query.prototype.nosqlQuery = function(statement) {
  this.op = 'nosqlQuery';
  this._statement = statement;
  if (Query.base && Query.base.nosqlQuery)
    Query.base.nosqlQuery.call(this, statement);

  return this;
};

/**
 * Execute a `nosqlQuery()`
 *
 * @return {Query} this
 * @api private
 */
Query.prototype._nosqlQuery = async function _nosqlQuery() {
  ...
  let options = this._optionsForExec();
  if (!options) {
    options = {};
  }
  options._schema = this.schema;

  const cursor = await this._collection.collection.nosqlQuery(statement, options);
  if (options != null && options.explain) {
    return cursor.explain();
  }
...
Query.prototype.findOne = function(conditions, projection, options) {
  if (typeof conditions === 'function' ||
    ...
    throw new OrcoosError('Query.prototype.findOne() no longer accepts a callback');
  }
...
Query.prototype.count = function(filter) {
  if (typeof filter === 'function' ||
      typeof arguments[1] === 'function') {
    throw new OrcoosError('Query.prototype.count() no longer accepts a callback');
  }
...
Query.prototype.estimatedDocumentCount = function(options) {
  if (typeof options === 'function' ||
      typeof arguments[1] === 'function') {
    throw new OrcoosError('Query.prototype.estimatedDocumentCount() no longer accepts a callback');
  }
...
Query.prototype.countDocuments = function(conditions, options) {
  if (typeof conditions === 'function' ||
    ...
    throw new OrcoosError('Query.prototype.countDocuments() no longer accepts a callback');
  }
...
Query.prototype.distinct = function(field, conditions) {
  if (typeof field === 'function' ||
      ...
      typeof arguments[2] === 'function') {
    throw new OrcoosError('Query.prototype.distinct() no longer accepts a callback');
  }
...
Query.prototype.deleteOne = function deleteOne(filter, options) {
  if (typeof filter === 'function' || typeof options === 'function' || typeof arguments[2] === 'function') {
    throw new OrcoosError('Query.prototype.deleteOne() no longer accepts a callback');
  }
  this.op = 'deleteOne';
  this.setOptions(options);
...
Query.prototype.deleteMany = function(filter, options) {
  if (typeof filter === 'function' || typeof options === 'function' || typeof arguments[2] === 'function') {
    throw new OrcoosError('Query.prototype.deleteMany() no longer accepts a callback');
  }
  this.setOptions(options);
  this.op = 'deleteMany';
...
Query.prototype.findOneAndUpdate = function(criteria, doc, options) {
  if (typeof conditions === 'function' ||
      ...
      typeof options === 'function' ||
      typeof arguments[3] === 'function') {
    throw new OrcoosError('Query.prototype.findOneAndUpdate() no longer accepts a callback');
  }
...
Query.prototype.findOneAndRemove = function(conditions, options) {
  if (typeof conditions === 'function' ||
      typeof options === 'function' ||
      typeof arguments[2] === 'function') {
    throw new OrcoosError('Query.prototype.findOneAndRemove() no longer accepts a callback');
  }
...
Query.prototype.findOneAndDelete = function(conditions, options) {
  if (typeof conditions === 'function' ||
      typeof options === 'function' ||
      typeof arguments[2] === 'function') {
    throw new OrcoosError('Query.prototype.findOneAndDelete() no longer accepts a callback');
  }
...
Query.prototype.findOneAndReplace = function(filter, replacement, options) {
  if (typeof filter === 'function' ||
    ...
    throw new OrcoosError('Query.prototype.findOneAndReplace() no longer accepts a callback');
  }
...
async function _updateThunk(op) {
  ...
  if (isOverwriting) {
    if (op === 'updateOne' || op === 'updateMany') {
      throw new OrcoosError('The MongoDB server disallows ' +
...
Query.prototype.validate = async function validate(castedDoc, options, isOverwriting) {
  if (typeof arguments[3] === 'function') {
    throw new OrcoosError('Query.prototype.validate() no longer accepts a callback');
  }
...
Query.prototype.exec = async function exec(op) {
  if (typeof op === 'function' || (arguments.length >= 2 && typeof arguments[1] === 'function')) {
    throw new OrcoosError('Query.prototype.exec() no longer accepts a callback');
  }
  ...
  if (this._executionStack != null) {
    ...
    const err = new OrcoosError('Query was already executed: ' + str);

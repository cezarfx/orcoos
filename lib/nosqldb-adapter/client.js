...
class OrcoosFindCursor {
    ...
    async fetchBatch() {
        ...
        if (!this._isStarted) {
            ...
            console.log('fetched ', this._documents.length, ' documents');
        }
        ...
        if (batch && batch?.value?.rows) {
            ...
            console.log('fetched extra ', this._documents.length, ' documents');
            return;
        } else {
            this.close();
        }
    ...
    // async toArray() {
    //     const infiniteArray = async function* () {
    //         if (this._isClosed) {
    //             return;
    //         }    
    //         if (!this._isStarted) {
    ...
    //     const prototypeOfInfiniteArray = Object.getPrototypeOf(infiniteArray);
    //     prototypeOfInfiniteArray.prototype.map = async function* (mapper, thisArg) {

...
class OrcoosCollection {
    ...
    async _queryPromise(client, stmt, bindings, maxLimit = MAX_QUERY_RESULTS_LIMIT) {        
        try {
            await this._checkTableIsCreated();
    ...
    async updateOne(filter, update, options) {
        ...
        if (filter && filter._id) {
            ...
            const r = await this._queryPromise(this.db.client, stmt, bindings);

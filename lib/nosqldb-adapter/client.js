...
class OrcoosCollection //extends Collection 
{
    ...
    async createTable() {
        ...
        try {
            ...
            if (table && table.tableState == TableState.ACTIVE) {
                // console.log("     o OCol.createTable() Table " + tableName + " already exists.");
                this._created = true;
                return;
            }
        } catch (e) {
        ...
        try {
            ...
            // console.log('     o OCol.createTable() Create table: ' + tableName + 
            //     "    " + stmt /*+ "   " + JSON.stringify(result)*/);
            this._created = true;
            return;
        } catch (e) {
    ...
    async deleteMany(filter, options) {
        ...
        try {               
            ...
            throw new Error("ISError: no response from deleteMany query.");
        } catch(error) {

...
export const SERVICE_CLOUD = 'cloud';
export const SERVICE_ON_PREM = 'on_prem';

export const PROTOCOL_HTTP = 'http';
export const PROTOCOL_HTTPS = 'https';

export const AUTH_TYPE_USER_PRINCIPAL = 'user_principal';
export const AUTH_TYPE_INSTANCE_PRINCIPAL = 'instance_principal';
export const AUTH_TYPE_RESOURCE_PRINCIPAL ='resource_principal';
export const AUTH_TYPE_OKE_WORKLOAD = 'oke_workload';
export const AUTH_TYPE_CLOUDSIM = 'cloudsim';
 ...
 *  - nosqldb://+cloudsim@localhost:8000 - connect to cloudsim on localhost:8000
 *  - nosqldb+on_prem://localhost:8080 - connect to on-prem at http://localhost:8080
 ...
 */
export class NoSQLConnectionString {
    constructor(connectionString) {
        ...
        console.log('   serviceType:', this._serviceType);
        // console.log('   url:', this._protocol + '://' + this._hosts.join(',') );
        console.log('   protocol:', this._protocol);
        console.log('   authType:', this._authType);
    }

    getClient() {
        return new oracleNoSqlDb.NoSQLClient(this.getClientConfig());
    }
    ...
    getClientConfig() {
        ...
        if (this._serviceType === SERVICE_CLOUD) {
            ...
            // for both on_prem and on_prem_secure

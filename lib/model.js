...
const OrcoosError = require('./error/index');
...
Model.prototype.$__handleSave = function(options, callback) {
  ...
  if (this.$isNew) {
    ...
    if ((obj || {})._id === void 0) {
      ...
      immediate(function() {
        callback(new OrcoosError('document must have an _id before saving'));
      });
      return;
    }
  ...
  if (delta) {
    if (delta instanceof OrcoosError) {
      callback(delta);
      return;
    }

    const where = this.$__where(delta[0]);
    if (where instanceof OrcoosError) {
      callback(where);
      return;
    }
...
Model.prototype.save = async function save(options) {
  if (typeof options === 'function' || typeof arguments[1] === 'function') {
    throw new OrcoosError('Model.prototype.save() no longer accepts a callback');
  }
...
Model.prototype.$__where = function _where(where) {
  ...
  if (this._doc._id === void 0) {
    return new OrcoosError('No _id found on document!');
  }
...
Model.prototype.deleteOne = async function deleteOne(options) {
  if (typeof options === 'function' ||
    ...
    throw new OrcoosError('Model.prototype.deleteOne() no longer accepts a callback');
  }
...
Model.exists = function exists(filter, options) {
  ...
  if (typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.exists() no longer accepts a callback');
  }
...
Model.discriminator = function(name, schema, options) {
  ...
  if (typeof name === 'function') {
    ...
    if (!(model.prototype instanceof Model)) {
      throw new OrcoosError('The provided class ' + name + ' must extend Model');
    }
  }
...
function _checkContext(ctx, fnName) {
  ...
  if (ctx == null || ctx === global) {
    throw new OrcoosError('`Model.' + fnName + '()` cannot run without a ' +
...
Model.init = function init() {
  ...
  if (typeof arguments[0] === 'function') {
    throw new OrcoosError('Model.init() no longer accepts a callback');
  }
  ...
  const _createCollection = async() => {
    ...
    return await this.createCollection({_schema: this.schema});
  };
...
Model.createCollection = async function createCollection(options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function') {
    throw new OrcoosError('Model.createCollection() no longer accepts a callback');
  }
...
Model.syncIndexes = async function syncIndexes(options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function') {
    throw new OrcoosError('Model.syncIndexes() no longer accepts a callback');
  }
...
Model.cleanIndexes = async function cleanIndexes(options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function') {
    throw new OrcoosError('Model.cleanIndexes() no longer accepts a callback');
  }
  const model = this;
...
Model.listIndexes = async function listIndexes() {
  ...
  if (typeof arguments[0] === 'function') {
    throw new OrcoosError('Model.listIndexes() no longer accepts a callback');
  }
...
Model.ensureIndexes = async function ensureIndexes(options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function') {
    throw new OrcoosError('Model.ensureIndexes() no longer accepts a callback');
  }
...
Model.createIndexes = async function createIndexes(options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function') {
    throw new OrcoosError('Model.createIndexes() no longer accepts a callback');
  }
...
function _ensureIndexes(model, options, callback) {
  ...
  for (const index of indexes) {
    if (isDefaultIdIndex(index)) {
      utils.warn('ondbmongoose: Cannot specify a custom index on `_id` for ' +
        'model name "' + model.modelName + '", ' +
        'Oracle NoSQL DB does not allow overwriting the default `_id` index.');
    }
  }
  ...
  function create() {
    ...
    model.collection.createIndex(indexFields, indexOptions, model.schema).then(
      name => {
...
Model.deleteMany = function deleteMany(conditions, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.deleteMany() no longer accepts a callback');
  }
...
Model.find = function find(conditions, projection, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function' || typeof arguments[3] === 'function') {
    throw new OrcoosError('Model.find() no longer accepts a callback');
  }
...
/**
 * Executes NoSQL DB SQL query.
 *
 * #### Example:
 *
 *     // find all documents
 *     await MyModel.nosqlQuery("select * from MyModelTable");
 *
 *     // find all documents named john and at least 18
 *     await MyModel.nosqlQuery("select * from MyModelTable t where t.kvjson.name = 'john' and t.kvjson.age >= 18").exec();
 *
 *     // executes, name LIKE john and only selecting the "name" and "friends" fields
 *     await MyModel.nosqlQuery("select {'kvjson': {'name': t.kvjson.name, 'friends': t.kvjson.friends}} from MyModelTable t where like_regex(t.kvjson.name, '/john/i')").exec();
 *
...
Model.nosqlQuery = function nosqlQuery(statement) {
  _checkContext(this, 'nosqlQuery');
  
  const mq = new this.Query({}, {}, this, this.$__collection);
  return mq.nosqlQuery(statement);
};
...
Model.findById = function findById(id, projection, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.findById() no longer accepts a callback');
  }
...
Model.findOne = function findOne(conditions, projection, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.findOne() no longer accepts a callback');
  }
...
Model.countDocuments = function countDocuments(conditions, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.countDocuments() no longer accepts a callback');
  }
...
Model.count = function count(conditions) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function') {
    throw new OrcoosError('Model.count() no longer accepts a callback');
  }
...
Model.distinct = function distinct(field, conditions) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function') {
    throw new OrcoosError('Model.distinct() no longer accepts a callback');
  }
...
Model.findOneAndUpdate = function(conditions, update, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function' || typeof arguments[3] === 'function') {
    throw new OrcoosError('Model.findOneAndUpdate() no longer accepts a callback');
  }
...
Model.findByIdAndUpdate = function(id, update, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function' || typeof arguments[3] === 'function') {
    throw new OrcoosError('Model.findByIdAndUpdate() no longer accepts a callback');
  }
...
Model.findOneAndDelete = function(conditions, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.findOneAndDelete() no longer accepts a callback');
  }
...
Model.findByIdAndDelete = function(id, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.findByIdAndDelete() no longer accepts a callback');
  }
...
Model.findOneAndReplace = function(filter, replacement, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function' || typeof arguments[3] === 'function') {
    throw new OrcoosError('Model.findOneAndReplace() no longer accepts a callback');
  }
...
Model.findOneAndRemove = function(conditions, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function' || typeof arguments[3] === 'function') {
    throw new OrcoosError('Model.findOneAndRemove() no longer accepts a callback');
  }
...
Model.findByIdAndRemove = function(id, options) {
  ...
  if (typeof arguments[0] === 'function' || typeof arguments[1] === 'function' || typeof arguments[2] === 'function' || typeof arguments[3] === 'function') {
    throw new OrcoosError('Model.findByIdAndRemove() no longer accepts a callback');
  }
...
Model.create = async function create(doc, options) {
  if (typeof options === 'function' ||
    ...
    throw new OrcoosError('Model.create() no longer accepts a callback');
  }
  ...
  if (Array.isArray(doc)) {
    ...
    if (args.length === 2 &&
      ...
      utils.warn('WARNING: to pass a `session` to `Model.create()` in ' +
        'Orcoos, you **must** pass an array as the first argument.');
    }
  }
  ...
  const res = await Promise.all(args.map(async doc => {
    const Model = this.discriminators && doc[discriminatorKey] != null ?
      ...
      this;
    if (Model == null) {
      throw new OrcoosError(`Discriminator "${doc[discriminatorKey]}" not ` +
...
Model.insertMany = async function insertMany(arr, options) {
  ...
  if (typeof options === 'function' ||
    typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.insertMany() no longer accepts a callback');
  }
...
Model.bulkWrite = async function bulkWrite(ops, options) {
  ...
  if (typeof options === 'function' ||
      typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.bulkWrite() no longer accepts a callback');
  }
  options = options || {};
...
Model.aggregate = function aggregate(pipeline, options) {
  ...
  if (typeof options === 'function' || typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.aggregate() no longer accepts a callback');
  }
...
Model.validate = async function validate(obj, pathsToValidate, context) {
  ...
  if (typeof context === 'function' || typeof arguments[3] === 'function') {
    throw new OrcoosError('Model.validate() no longer accepts a callback');
  }
...
Model.populate = async function populate(docs, paths) {
  ...
  if (typeof paths === 'function' || typeof arguments[2] === 'function') {
    throw new OrcoosError('Model.populate() no longer accepts a callback');
  }
...
function populate(model, docs, options, callback) {
  ...
  if (modelsMap instanceof OrcoosError) {

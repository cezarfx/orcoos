...
AggregationCursor.prototype.close = async function close() {
  if (typeof arguments[0] === 'function') {
    throw new OrcoosError('AggregationCursor.prototype.close() no longer accepts a callback');
  }
  try {
...
AggregationCursor.prototype.next = async function next() {
  if (typeof arguments[0] === 'function') {
    throw new OrcoosError('AggregationCursor.prototype.next() no longer accepts a callback');
  }

...
QueryCursor.prototype.close = async function close() {
  if (typeof arguments[0] === 'function') {
    throw new OrcoosError('QueryCursor.prototype.close() no longer accepts a callback');
  }
  try {
...
QueryCursor.prototype.next = async function next() {
  if (arguments[0] === 'function') {
    throw new OrcoosError('QueryCursor.prototype.next() no longer accepts a callback');
  }
